...
# 构建filtergraph
filter_complex = f"""
[0:v]loop=loop=-1:size=1:start=0,trim=duration={segment_duration},setpts=PTS-STARTPTS,scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,setsar=1[v0];
[1:v]loop=loop=-1:size=1:start=0,trim=duration={segment_duration},setpts=PTS-STARTPTS,scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,setsar=1[v1];
[2:v]loop=loop=-1:size=1:start=0,trim=duration={segment_duration},setpts=PTS-STARTPTS,scale=1080:1920:force_original_aspect_ratio=increase,crop=1080:1920,setsar=1[v2];
