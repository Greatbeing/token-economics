...
version: 1.0.0
description: "日程待办摘要：编排 calendar +agenda 和 task +get-my-tasks，生成指定日期的日程与未完成任务摘要。适用于了解今天/明天/本周的安排。实际任务执行时只在主agent执行，不要在子agent执行。"
metadata:
  requires:
    bins: ["lark-cli"]
---
...
- [lark-calendar](../lark-calendar/SUB_SKILL.md) — `+agenda` 详细用法
- [lark-task](../lark-task/SUB_SKILL.md) — `+get-my-tasks` 详细用法
