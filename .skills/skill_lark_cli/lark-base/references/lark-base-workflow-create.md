...
- ⚠️ **权限不足**：如遇 `permission denied`，先确认当前身份（bot 或 user）是否对该 Base 有编辑权限，再检查 scope 是否已开通。参考 [lark-shared](../../lark-shared/SUB_SKILL.md) 中的权限不足处理流程
...
- [lark-base](../SUB_SKILL.md) — 多维表格全部命令
