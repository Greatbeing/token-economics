...
关于如何设计画板内容，以及如何使用 whiteboard-cli，参考 [`../lark-whiteboard/SUB_SKILL.md`](../../lark-whiteboard/SUB_SKILL.md)。
...
此处不提供示例调用，请参考 [`../lark-whiteboard/SUB_SKILL.md`](../../lark-whiteboard/SUB_SKILL.md) 了解完整的使用流程。
